  ...
  return (
    <>
      <div className="flex h-screen w-screen bg-transparent backdrop-blur-md justify-center items-center font-poppins">
        <div className="md:h-3/4 w-[80%] md:w-3/4 bg-white shadow-sm shadow-black  text-gray-100 p-0 md:pt-[8vh]  pb-5 box-border overflow-y-auto  rounded-md ">
          <div className="flex justify-between p-5 h-[8vh] box-border rounded-md rounded-b-none  w-full absolute top-[12.5vh] z-10 bg-black b-800 md:w-[75%] md:pl-[5vw] text-2xl text-gray-100 items-center">
          ...
          <div className="m-auto w-full    space-y-4 h-auto md:mt-[0vh] md:pl-[5vw] md:p-4 rounded-md pt-[0vh] overflow-y-auto pb-[2vh]">
            {" "}
            <ul className="grid grid-cols-1 gap-2 md:gap-0 text-gray-700 space-y-5 text-sm md:text-xl  overflow-y-auto">
            ...
            <div className="space-y-2 text-gray-700 cursor-default">
              {recentTransactions
                ...
                .map((item, index) => (
                  <ul
                    key={index}
                    className="grid grid-cols-4 space-y-0 text-center text-sm md:text-xl items-center capitalize "
                  >
