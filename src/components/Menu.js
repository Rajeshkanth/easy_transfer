...
function Menu(props) {
  ...
  return (
    <div className="h-custom-10 fixed md:relative w-screen z-20 bg-gray-800 pb-2 sm:pb-0 pt-2 md:pt-0 flex items-center justify-between sm:justify-between sm:pr-8  md:justify-around font-sans ">
      <div className=" items-center ml-2 pt-1 pb-1">
        <img
          src={logo}
          className=" items-center object-contain  w-40 md:w-28 lg:w-24 font-bold ml-8 text-center  sm:ml-0  text-2xl lg:text-4xl  box-border   "
          onClick={() => home()}
        ></img>
      </div>
      {windowWidth > 640 ? (
        ...
        <h1
          className="fixed left-8/5  font-bold text-2xl items-center text-center"
